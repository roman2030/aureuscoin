...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("AureusCoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "AureusCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    //{"52.0.120.190", "52.0.120.190"},
    {"34.228.253.152","34.228.253.152"},
    {"50.16.195.181", "50.16.195.181"},
    {"50.16.197.196", "50.16.197.196"}
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("AureusCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("AureusCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("AureusCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("AureusCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. AureusCoin is probably already running."), addrBind.ToString().c_str());
        else
